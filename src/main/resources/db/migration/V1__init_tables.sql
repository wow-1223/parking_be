...
CREATE TABLE orders (
    ...
    status TINYINT NOT NULL DEFAULT 0 COMMENT 'status: 0:pending payment | 1:reserved | 2:locked | 3:processing | 4:completed | 5: canceling | 6: canceled | 7:refunding | 8:refunded | 9:overdue | 10: overdue pending payment | 11:leave temporarily',
